...
export const ZingChartIcon = ({ width = '1.5rem', height = '1.5rem', className }) => (
    <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="currentColor">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
export const RadioIcon = ({ width = '1.5rem', height = '1.5rem', className }) => (
    <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="currentColor">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
export const LibraryIcon = ({ width = '1.5rem', height = '1.5rem', className }) => (
    <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="currentColor">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
export const ChartIcon = ({ width = '1.5rem', height = '1.5rem', className }) => (
    <svg className={className} width={width} height={height} viewBox="0 0 24 24" fill="currentColor">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
export const HubIcon = ({ width = '1.5rem', height = '1.5rem', className }) => (
...
export const PlayOutlineIcon = ({ width = '1.25rem', height = '1.25rem', className }) => (
    <svg className={className} width={width} height={height} viewBox="0 0 20 20" fill="currentColor">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
export const DownloadIcon = ({ width = '1.25rem', height = '1.25rem', className }) => (
...
export const ArrowLeftIcon = ({ width = '1.5rem', height = '1.5rem', className }) => (
    <svg
...
export const ArrowRightIcon = ({ width = '1.5rem', height = '1.5rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        width={width}
...
export const ChevronLeftIcon = ({ width = '3rem', height = '3rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        width={width}
...
export const ChevronRightIcon = ({ width = '3rem', height = '3rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        width={width}
...
export const ClearIcon = ({ width = '0.875rem', height = '0.875rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        width={width}
...
export const SettingIcon = ({ width = '1.25rem', height = '1.25rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        width={width}
...
export const HeartIcon = ({ width = '1rem', height = '1rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
...
export const MoreIcon = ({ width = '1rem', height = '1rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        width={width}
